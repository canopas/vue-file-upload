<template>
  <p class="mt-5 ms-6 dark:text-white">Single File Upload</p>
    ...
    <SingleFileUpload :uploadedFile="uploadedFile" :callback="handleFileUploading">
      <template v-slot="file">
        ...
        <div class="m-5">
          <div class="flex items-center justify-center">
            ...
            <div v-else>
              <div class="w-full h-64">
                <img
                  v-if="uploadedFile || file.file.previewType != 'video'"
                  class="h-full w-full object-contain rounded-2xl"
                  :src="
                    file.file.previewUrl ? file.file.previewUrl : uploadedFile ? uploadedFile : ''
                  "
                />
          ...
          <p class="flex items-center justify-center text-center w-3/4 dark:text-white">
  ...
  <br />
  <hr />
  <p class="mt-5 ms-6 dark:text-white">Multiple File Upload</p>
  <div class="flex flex-wrap">
    <MultipleFileUpload
